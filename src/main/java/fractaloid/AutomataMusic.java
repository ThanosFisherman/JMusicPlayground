...
import fractaloid.inst.TriangleInst;
import jm.JMC;
...
import jm.music.tools.ca.DrawCA;
import jm.util.View;
...
public class AutomataMusic implements JMC{
    ...
    public AutomataMusic() {
        ...
        CellularAutomata CA = new CellularAutomata(cells.length, cells[0].length, 0, false);
        ...
        for(int i=0;i<maxNotes;i++) {
            ...
            noteNumber = liveCellCounter + (127 - cells.length*cells[0].length); //pitch offset
